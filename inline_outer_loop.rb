...
n.times do
  b = BODIES[0]
  b.move_from_i(BODIES, nbodies, dt, 0 + 1)
  b = BODIES[1]
  b.move_from_i(BODIES, nbodies, dt, 1 + 1)
  b = BODIES[2]
  b.move_from_i(BODIES, nbodies, dt, 2 + 1)
  b = BODIES[3]
  b.move_from_i(BODIES, nbodies, dt, 3 + 1)
  b = BODIES[4]
  b.move_from_i(BODIES, nbodies, dt, 4 + 1)
end
